...
//ghi chu
  ...
  listenToTokenTransfer = () => {
    this.tokenInstance.events.Transfer({to: this.accounts[0]}).on("date", this.updateUserTokens);
  }
  ...
  render() {
    ...
    return (
      ...
      <p>You currtently have ： {this.state.userTokens} CAPPU Tokens</p>
